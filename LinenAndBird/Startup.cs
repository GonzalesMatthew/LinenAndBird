...
namespace LinenAndBird
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddTransient<IConfiguration>() -> anytime someone 'asks' for IConfiguration, give them a brand new one. that is what Transient means
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapControllers(); // references controller attributes
            });
        }
    }
}
